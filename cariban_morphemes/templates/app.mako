                ...
                <%block name="footer">
                    <div class="row-fluid" style="padding-top: 15px; border-top: 1px solid black;">
                        ...
                        <div class="span3" style="text-align: right;">
                            ...
                            <a href="https://gitlab.com/${request.registry.settings['clld.github_repos']}">
                                ...
                                % endif
                                on<br/>
                                <img height="40" width="100" src="${request.static_url('cariban_morphemes:static/images/gitlab_logo.png')}" />
                            </a>
                            % endif
                        </div>
                    </div>
